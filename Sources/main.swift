...
class AppDelegate: NSObject, NSApplicationDelegate, AudioTranscriptionManagerDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Create menu
        let menu = NSMenu()
        menu.addItem(NSMenuItem(title: "Recording: Press Ctrl+Option+Space", action: nil, keyEquivalent: ""))
        menu.addItem(NSMenuItem(title: "History: Press Cmd+Option+A", action: nil, keyEquivalent: ""))
    ...
    func pasteTextAtCursor(_ text: String) {
        ...
        // After a short delay, restore clipboard
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.2) { [weak self] in
            ...
            // Apps where paste typically fails
            let problematicApps = [
                "com.apple.finder",
                "com.apple.dock",
